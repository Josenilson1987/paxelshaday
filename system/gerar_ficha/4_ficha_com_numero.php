...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="principal">
            ...
            <form action="system/gerar_ficha/gerar_ficha_4.php" method="post" class="form-inline" target="black">
                ...
                <div id="tabela1">
                    ...
                    <div id="painel_form1" class="well well-lg">
                        ...
                        <input   class="   form-control cpf " required style="width: 150px;" type="text" name="cpf_titular_2"   maxlength="11" autofocus/>
                        <label>NÚMERO FICHA</label>
                        <input   class="   form-control  " required style="width: 50px;" type="text" name="n_ficha_2"   onkeyup="somenteNumeros(this);"/>

                        <label>3º TITULAR</label>                      
                        <input   class="   form-control cpf " required style="width: 150px;" type="text" name="cpf_titular_3"   maxlength="11" autofocus/>
                        <label>NÚMERO FICHA</label>
                        <input   class="   form-control  " required style="width: 50px;" type="text" name="n_ficha_3"   onkeyup="somenteNumeros(this);"/>
                        
                        <label>4º TITULAR</label>                      
                        <input   class="   form-control cpf " required style="width: 150px;" type="text" name="cpf_titular_4"   maxlength="11" autofocus/>
                        <label>NÚMERO FICHA</label>
                        <input   class="   form-control  " required style="width: 50px;" type="text" name="n_ficha_4"   onkeyup="somenteNumeros(this);"/>
