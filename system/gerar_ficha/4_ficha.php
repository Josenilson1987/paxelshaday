...
<html lang="pt-br">
    ...
    <body>
        <div id="principal">
            <form action="system/gerar_ficha/gerar_ficha_4.php" method="post" class="form-group" target="black">
                ...
                <div id="tabela1">
                    ...
                    <div id="painel_form1" class="well well-lg">
                        ...
                        <input   class="   form-control to-uppercase cpf " required  style="width: 160px;" type="text" name="cpf_titular_3"  maxlength="11" >
                        <label>4º TITULAR</label>
                        <input   class="   form-control to-uppercase cpf "  required style="width: 160px;" type="text" name="cpf_titular_4"   maxlength="11" >
