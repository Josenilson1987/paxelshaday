...
if (!empty($data['SendPostForm'])):
    ...
    elseif ($verifica_cpf_falecido->getResult()):
        ...
        header('refresh: 5;painel.php?exe=gerador_de_guia_sepultamento/A4/index&index=true&cpf_responsavel=' . $data["cpf_responsavel"]);
            ...
            <form class="uppercase form-inline" name="Formcliente" action="" method="post"  >
                ...
                <div class="form-inline ">
                    ...
                    <?php if (!isset($data)) { ?>  
                        ...
                        <legend style="text-align: center; color: green;">Informações do Responsável  (a):</legend>
                        <br>
                        <label>Nome:</label>
