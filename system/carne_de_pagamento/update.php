...
<html lang="pt-br">
    ...
    <td>
        <form action="" method="post" class="form-inline">
            ...
            <label>Cpf:</label>
            <input style="width:200px; font-size: 13px; " type="text" name="cpf"  class="form-control" value="<?php if (isset($listarficha)) echo $listarficha->getResult()[0]['cpf_titular']; ?>" readonly/>
