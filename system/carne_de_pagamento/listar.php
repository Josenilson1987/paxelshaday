...
if (!isset($data['SendPostForm'])):
    ...
    if (!$read->getResult()):
        ...
        header('Location: painel.php?exe=/carne_de_pagamento/index');
    else:
        ...
        header("refresh: 5;painel.php?exe=carne_de_pagamento/listar&listar=true&cpf_titular=" . "$cpf_titular");
...
<html lang="pt-br">
    ...
    <body>
        ...
        <form method="POST">
            <button type="submit" class="btn btn-primary" name="SendPostForm">Gerar Novo carne</button> 
        </form>
...
// REALIZA UMA CONSULTA NA TABELA FICHA DE PAGAMENTO E RETORNA AS FICHAS CADASTRADAS 
        ...
        if (!$listarficha->getResult()):
            ...
            foreach ($listarficha->getResult() as $listarficha):
                ...
                <tr class="to-uppercase">
                    ...
                    <? $listarficha["qtd"] = 12; ?>
                    <? $listarficha["mes_inicial"]; ?>

                    <td><a class="btn  btn-success" href='painel.php?exe=carne_de_pagamento/update&ficha_pagamento_id=<?= $listarficha["ficha_pagamento_id"]; ?>'>Editar</a></td>

                    <td>
                        <form action="system/carne_de_pagamento/carne.php" method="post" class="form-inline" target="blank">
                            ...
                            <input  required class="form-control to-uppercase"  style="width: 150px;" type="hidden" name="data_cadastrada"  value="<?php if (isset($listarficha)) echo $listarficha['data_cadastrada']; ?>" readonly>
                            ...
                            <td><a class="btn  btn-primary" href='painel.php?exe=carne_de_pagamento/carne&ficha_pagamento_id=<?= $listarficha["ficha_pagamento_id"]; ?>'>Gerar</a></td>
                            
                          
                             <td><a href="painel.php?exe=ficha_de_pagamento/listar&delete=<?= $listarficha["ficha_pagamento_id"]; ?>" 
                             onclick="return confirm('Confirmar exclusão de registro?');"class="btn btn-danger">Delete</a></td>
