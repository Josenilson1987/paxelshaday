...
if (isset($_POST['gerar_ficha'])):
    ...
    $N_contrato3 = filter_input(INPUT_POST, "N_contrato3", FILTER_SANITIZE_STRING);
    $ano_inscricao3 = filter_input(INPUT_POST, "ano_inscricao3", FILTER_SANITIZE_STRING);
    $titular3 = filter_input(INPUT_POST, "titular3", FILTER_SANITIZE_STRING);
    $ano_inicial3 = filter_input(INPUT_POST, "ano_inicial3", FILTER_SANITIZE_STRING);
    $ano_final3 = filter_input(INPUT_POST, "ano_final3", FILTER_SANITIZE_STRING);
    $v_parcela3 = filter_input(INPUT_POST, "v_parcela3", FILTER_SANITIZE_STRING);
    $n_parcela3 = filter_input(INPUT_POST, "n_parcela3", FILTER_SANITIZE_STRING);
    $mes_inicial3 = filter_input(INPUT_POST, "mes_inicial3", FILTER_SANITIZE_STRING);
    $endereco3 = filter_input(INPUT_POST, "endereco3", FILTER_SANITIZE_STRING);
//---------------------------------------------------------------------------
