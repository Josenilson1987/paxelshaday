...
if (!empty($data['SendPostForm'])):
    ...
    header("refresh: 2;painel.php?exe=gerar_ficha/listar&listar=true&cpf=" . "$cpf");
...
<html lang="pt-br">
    ...
    <td>
        <form action="" method="post" class="form-inline">
            ...
            <input style="width:100px;font-size: 13px" type="text" name="mes_inicial"  required class="form-control" value="<?php if (isset($listarficha)) echo $listarficha->getResult()[0]['mes_inicial']; ?>" readonly/>
            <label>Ano inicial:</label>
            <input style="width:100px;font-size: 13px" type="text" name="ano_inicial"  required class="form-control" value="<?php if (isset($listarficha)) echo $listarficha->getResult()[0]['ano_inicial']; ?>" readonly/>
            <label>Ano final:</label>
            <input style="width:100px;font-size: 13px" type="text" name="ano_final"  required class="form-control" value="<?php if (isset($listarficha)) echo $listarficha->getResult()[0]['ano_final']; ?>" readonly/>
