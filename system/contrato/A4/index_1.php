...
<?php
$cpf_titular = filter_input(INPUT_GET, 'cpf', FILTER_DEFAULT);


$ReadTitular = new Read;
$ReadTitular->ExeRead("clientes", "WHERE cpf='$cpf_titular'");
...
<html >
    ...
    <page size="A4">
        ...
        <div class="caixa_de_texto">
            ...
            inscrito no cpf: <b class="to-uppercase">  <?= $ReadTitular['cpf'] ?>  </b>, 
