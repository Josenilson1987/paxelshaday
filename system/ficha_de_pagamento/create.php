...
$cpf_titular = filter_input(INPUT_GET, 'cpf_titular', FILTER_SANITIZE_STRING);
                ...
                <div class="well well-lg Form_cliente form-inline content form_create  " >
                    ...
                    <form class="uppercase" name="Formcliente" action="" method="post" id="Formcliente" >
                        ...
                        <div class="well well-lg form-inline">
                            ...
                            <input style="width:200px; font-size: 13px; " type="text" name="cpf_titular"  class="form-control" value="<?php if (isset($cpf_titular)) echo $cpf_titular; ?>" readonly/>
