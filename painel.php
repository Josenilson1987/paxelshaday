...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="menu" >
            ...
            <!--            
                        <li><a href="#" class="parent"><span>CONSULTAR </span></a>
                            <div><ul>
            
                                    <li><a href="#"><span>Cliente</span></a></li>
                                    <li><a href="#"><span>Dependente</span></a></li>
                                    <li><a href="#"><span>Ficha De Pagamento</span></a></li>
                                    <li><a href="#"><span>Cemitério</span></a></li>
                                    <li><a href="#"><span>Cartório</span></a></li>
                                    <li><a href="#" class="parent"><span>Guia de Sepultamento</span></a>
                                        <div><ul>
                                                <li><a href="painel.php?exe=guia_de_sepultamento/particular/consultar   "><span>Particular</span></a></li>
                                                <li><a href="painel.php?exe=guia_de_sepultamento/titular/consular_titular/index"><span>Titular plano</span></a></li>
                                                <li><a href="painel.php?exe=guia_de_sepultamento/dependentes/consultar_dependentes/index"><span>Dependentes</span></a></li>
